...
| 优先级 | 服务 | 命中策略组 | 默认选择 |
|---:|---|---|---|
| 1 | DNS 防泄露 / HTTPDNS | `🧱 DNS 防泄露` | `🚀 节点选择` |
| 2 | MissAV 主站、CDN、推荐接口及含 `missav` 的域名 | `📺 MissAV` | `🚀 节点选择` |
| 3 | 谷歌服务（含 Gemini） | `🔍 谷歌服务` | `🚀 节点选择` |
| 4 | AI 服务（ChatGPT、Claude 等） | `🤖 AI 服务` | `🚀 节点选择` |
| 5 | 油管视频 | `📹 油管视频` | `🚀 节点选择` |
| 6 | 哔哩哔哩 | `🔒 国内服务` | `🚀 节点选择` |
| 7 | 私有网络 / 局域网 | `🏠 私有网络` | `🚀 节点选择` |
| 8 | 电报消息 | `📲 电报消息` | `🚀 节点选择` |
| 9 | GitHub、GitLab、Atlassian | `🐱 代码托管` | `🚀 节点选择` |
| 10 | 微软服务 | `Ⓜ️ 微软服务` | `🚀 节点选择` |
| 11 | 汇丰香港及 Reward+ | `🏦 汇丰香港` | `🚀 节点选择` |
| 12 | 其他香港银行 | `🏦 香港银行` | `🚀 节点选择` |
| 13 | 券商服务 | `📈 券商服务` | `🚀 节点选择` |
| 14 | Apple Push | `🍎 苹果推送` | `🚀 节点选择` |
| 15 | 其他苹果服务 | `🍏 苹果服务` | `🚀 节点选择` |
| 16 | 国内服务 | `🔒 国内服务` | `🚀 节点选择` |
| 17 | 其他境外流量 | `🌍 非中国` | `🚀 节点选择` |
| 18 | 中国大陆 IP | `🔒 国内服务` | `🚀 节点选择` |
| 19 | 未匹配流量 | `🐟 漏网之鱼` | `🚀 节点选择` |
...
- `MissAV.list`、MissAV 关键词兜底、`🚀 节点选择` 组以及 `url-test` → `select` 的改动，只要上游没有重写对应区域，通常会保留。
